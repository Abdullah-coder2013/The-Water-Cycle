...
public class Condensation : MonoBehaviour
{
    ...
    private IEnumerator StartFactsWithDelay()
    {
        ...
        Information.Instance.StartFactSequence(WaterCycleStage.Condensation);
    }
    ...
    private void GenerateObstaclesForSceneSegment(GameObject segment)
    {
        ...
        for (int i = 0; i < obstacleCount; i++)
        {
            ...
            Vector3 position = segment.transform.position + new Vector3(Random.Range(-4f, 4f), Random.Range(-5f, 5f), 0);
